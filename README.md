...
ContainerService (CRUD + lifecycle + log stream + stats + exec),
ImageService, VolumeService, NetworkService, ComposeService, SystemService.
Bindings live in `sdk/go/gen` (`micropodv1connect`).
