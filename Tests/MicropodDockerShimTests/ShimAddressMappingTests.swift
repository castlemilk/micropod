...
final class ShimAddressMappingTests: XCTestCase {
    func testCIDRAddressIsSplitIntoAddressAndPrefix() {
        XCTAssertEqual(DockerMapper.bareAddress("192.168.64.16/24"), "192.168.64.16")
        XCTAssertEqual(DockerMapper.addressPrefixLength("192.168.64.16/24"), 24)
    }

    func testBareAddressIsPassedThrough() {
        XCTAssertEqual(DockerMapper.bareAddress("192.168.64.16"), "192.168.64.16")
        XCTAssertEqual(
    ...
    func testEmptyAddressStaysEmpty() {
        XCTAssertEqual(DockerMapper.bareAddress(""), "")
    ...
    func testIPv6CIDRIsSplit() {
        ...
        XCTAssertEqual(DockerMapper.bareAddress(v6), "fd1c:bd31:1e48:528f:f812:c7ff:fe2a:7961")
    ...
    func testNonNumericPrefixIsZero() {
        XCTAssertEqual(DockerMapper.bareAddress("192.168.64.16/abc"), "192.168.64.16")
