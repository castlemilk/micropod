...
const (
	ImageService_ListImages_FullMethodName  = "/micropod.v1.ImageService/ListImages"
	ImageService_PullImage_FullMethodName   = "/micropod.v1.ImageService/PullImage"
	ImageService_DeleteImage_FullMethodName = "/micropod.v1.ImageService/DeleteImage"
)
...
func (c *imageServiceClient) PullImage(ctx context.Context, in *PullImageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ProgressLine], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ImageService_PullImageClient = grpc.ServerStreamingClient[ProgressLine]
...
func (UnimplementedImageServiceServer) PullImage(*PullImageRequest, grpc.ServerStreamingServer[ProgressLine]) error {
...
func _ImageService_PullImage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ImageServiceServer).PullImage(m, &grpc.GenericServerStream[PullImageRequest, ProgressLine]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ImageService_PullImageServer = grpc.ServerStreamingServer[ProgressLine]
...
var ImageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "micropod.v1.ImageService",
	...
	Metadata: "micropod/v1/image.proto",
}
